...
<body onload="loader()">
  ...
  <!-- store  -->
  <div class="container-fluid mt-2 store">
    <!-- sorting navbar -->
    <form method="post">
      ...
      <div class="row">
        <div class="col-md-10 mx-auto">
          <div class="card-columns">
            <?php
            $select = "SELECT* FROM store WHERE collectiontype='Accessories' ORDER BY pid DESC";
  ...
  <!-- bottom navbar -->
  <div class="container-fluid bg-white py-2 fixed-bottom" id="bottomNav">
