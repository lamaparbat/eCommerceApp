...
if(isset($_POST["submit"])){
  ...
  $update_query = "UPDATE sale SET pname = '$pname',pprice = '$pprice',pdiscount = '$pdiscount' WHERE pid = '$pid'";
...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print ">
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href=""><i class="icon-docs"></i><span>Setting</span></a>
                </li>
      ...
      <div class="content-wrapper" >
         ...
         <div class="container">
           <div class="row">
             <div class="col-md-4">
              <h4 class="pt-4">SALE OFFER (% OFF)</h4><hr>
               <form class="form" method="post" action="offer.php" enctype="multipart/form-data">
                <label>Product ID</label>
                 <input class="form-control mb-3" type="text" name="pid" placeholder="Product ID" id="pid">
                 <label>Product Name</label>
                 <input class="form-control mb-3" type="text" name="pname" placeholder="Product Name" id="pname">
                 <label>Product Price</label>
                 <input class="form-control mb-3" type="text" name="pprice" placeholder="Product Price" id="pprice">
                 <label>Product Discount</label>
                 <input class="form-control mb-3" type="text" name="pdiscount" placeholder="Enter Discount% You offer " id="pdiscount">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="card card2">
                  ...
                  <div class="card-body">
                    <b><h6 class="card-title" style="margin-top: -15px;"><?php echo $row['pname']; ?></h6></b>
                    <p class="card-title" style="margin-top: -10px;"><label class="text-danger"><del>$USD<?php echo $row['pprice']; ?></del></label> &nbsp <?php echo $row['discount']; ?>% OFF</p>
                    <a class="btn btn-dark text-white" style="font-size: 13px;" onclick="update(<?php echo $row['pid']; ?>,'<?php echo $row['pname']; ?>',<?php echo $row['pprice']; ?>,<?php echo $row['pdiscount']; ?>)">UPDATE</a>
                    <a class="btn btn-danger text-white ml-3" style="font-size: 13px;" onclick="Delete(<?php echo $row['pid']; ?>)">Remove</a>
                  </div>
                </div>
              </div> 
              <?php } } ?>
   ...
   <script>
     ...
     function update(pid,pname,pprice,pdiscount){
      $(".content-wrapper .container .row .col-md-4 .form #pid").val(pid);
      $(".content-wrapper .container .row .col-md-4 .form #pname").val(pname);
      $(".content-wrapper .container .row .col-md-4 .form #pprice").val(pprice);
      $(".content-wrapper .container .row .col-md-4 .form #pdiscount").val(pdiscount);
