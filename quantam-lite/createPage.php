...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <div class="content-wrapper" style="background-color:white;">
         ...
         <br><br><h4 class="ml-3">Create a new Pages</h4><br>
         <div class="row pl-3 pr-3">
           <div class="col-md-5">
             <form class="form" id="form" method="post">
                 ...
                 <textarea class="form-control mb-3" type="" name="description" placeholder="Enter Page Description " id="description" required=""></textarea>
                 <input type="submit" name="submit" class="btn btn-primary" value="Upload" id="upload"><br><br><br><br><br><br><br><br>
               </form>
           </div><br>
         </div>
