...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <div class="content-wrapper pt-5" style="background-color:white;">
         ...
         <h4 class="ml-2">List Coupons</h4>
         <div class="row p-1 mt-3">
           <div class="col-md-7">
             <!--Coupon list displaying in table -->
                <table class="table bg-white" style="margin-bottom: 450px;">
                  <!-- table heading -->
                  <thead>
                    <tr>
                  ...
                  ?>
                    <tr class="col bg-danger">
                      ...
                      <td>$USD <?php echo $row["discount"]; ?></td>
                      ...
                      <td width="150px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class="icon-trash" onclick="delete_coupon(<?php echo $row["id"]; ?>)"></i></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
