...
if(isset($_POST["submit"])){
  ...
  //insert query
$insert_query = "INSERT INTO menu(name, status, date) VALUES('$name','$status','$date')";
...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <!-- Sidebar chat end-->
      <div class="content-wrapper pt-5 pb-5" style="background-color:white;">
         <!-- Container-fluid starts -->
         <h4 class="ml-3">Create a new Coupons</h4><br>
         <div class="row pl-3 pr-3">
           <div class="col-md-5">
             <form class="form" id="form" method="post" action="createMenu.php">
                 <label> Menu Name</label>
                 <input class="form-control mb-3" type="text" name="name" placeholder="Enter Menu Name " id="name" required="">
                 <label> Status</label>
                 ...
                 <input type="submit" name="submit" class="btn btn-primary" value="Upload" id="upload"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
               </form>
           </div><br>
         </div>
  ...
  <!-- Required Jqurey -->
   ...
   <script>
     ...
     function update(pid,ctype,ptype,pname,pprice,img){
      ...
      // refresh the page
      function refresh(){
        location.assign("createMenu.php");
      }
   </script>  
</body>
</html>
