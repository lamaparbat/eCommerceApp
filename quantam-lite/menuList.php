...
if(isset($_POST["submit"])){
  ...
  $query = "DELETE FROM list WHERE id='$cid'";
...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <div class="content-wrapper pt-5">
         ...
         <h4 class="ml-2">Menu Lists</h4>
         <div class="row p-1 mt-3">
           <div class="col-md-10">
             <!--Coupon list displaying in table -->
                <table class="table bg-white" style="margin-bottom: 500px;">
                  <!-- table heading -->
                  <thead>
                    <tr>
                  ...
                  ?>
                    <tr class="col bg-danger">
                      ...
                      <td width="100px"><?php echo $row["status"]; ?></td>
                      <form method="post">
