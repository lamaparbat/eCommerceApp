...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <div class="content-wrapper pt-5" style="background-color:white;">
         ...
         <h4 class="ml-3">User Lists</h4>
         <div class="row p-1">
           <div class="col-md-6">
             <!--Coupon list displaying in table -->
                <table class="table bg-white table-responsive" style="margin-bottom: 450px;">
                  <!-- table heading -->
                  <thead>
                    <tr>
                  ...
                  ?>
                    <tr class="col bg-danger">
                      <td><img src="/aroma/quantam-lite/upload/<?php echo $row["img"]; ?>" height="40px" width="40px" class="img-circle"></td>
                      ...
                      <td>&nbsp&nbsp<i class="icon-trash" onclick="delete_coupon(<?php echo $row["id"]; ?>)"></i></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
