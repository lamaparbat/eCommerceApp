...
if(isset($_POST["submit"])){
  ...
  //insert query
  $insert_query = "INSERT INTO page(name, description, date) VALUES('$name','$description','$date')";
...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <!-- Sidebar chat end-->
      <div class="content-wrapper p-5" style="background-color:white;">
         <!-- Container-fluid starts -->
         <h4 class="ml-3">Create a new Vendor</h4><br>
         <div class="row pl-3 pr-3">
           <div class="col-md-5">
             <form class="form" id="form" method="post" action="createPage.php">
                 <label> User Full Name</label>
                 <input class="form-control mb-3" type="text" name="name" placeholder="Enter Page Name " id="name" required="">
                 <label>Email</label>
                 <input class="form-control mb-3" type="email" name="email" id="email" placeholder="Enter Email or Phone Number">
                 <label> Password</label>
                 <input class="form-control mb-3" type="password" name="password" id="password" placeholder="Enter Email or Password">
                 <label> Confirm Password</label>
                 <input class="form-control mb-3" type="password" name="repassword" id="repassword" placeholder="Enter Password Again">
                 <input type="submit" name="submit" class="btn btn-primary" value="Upload" id="upload"><br><br><br><br><br><br><br><br><br>
               </form>
           </div><br>
         </div>
