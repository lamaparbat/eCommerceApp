...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
               ...
               <ul class="top-nav">
                  ...
                  <li class="dropdown">
                     <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                        <span><img class="img-circle" height="30px" width="30px" src="/quantam-lite/upload/<?php echo $img; ?>" alt="User Image"></span>
      ...
      <div class="content-wrapper pt-5" style="background-color:white;">
         ...
         <div class="row p-1 pt-4 mt-3 bg-white">
           <div class="col-md-10">
            <br><h4 class="ml-2">Invoice Details</h4><hr>
             <!-- client information -->
             <div class="row">
                <?php 
               ...
               <div class="col-md-9 pl-4">
                 ...
                 <h6><?php echo $row["customer"]; ?></h6>
                 <h6><?php echo $row["email"]; ?></h6>
                 <h6><?php echo $row["location"]; ?></h6>
               </div>
               <div class="col-md-3 pl-4">
                 <h5>Payment Details</h5>
                 <h6>Date of Invoice: <?php echo $row["date"]; ?></h6>
                 <h6>Due Date: <?php echo $row["due"]; ?></h6>
                 <h6>VAT: 13%</h6>
               </div>
             </div><br>
