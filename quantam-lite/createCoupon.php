...
if(isset($_POST["submit"])){
  ...
  //insert query
  $insert_query = "INSERT INTO coupon(title, code, start, end, discount) VALUES('$title','$code','$start','$end','$discount')";
...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <aside class="main-sidebar hidden-print ">
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="public_html/admin-login.php"><i class="icon-docs"></i><span>Login</span></a></li>
            </ul>
         </section>
      </aside>  
      <!-- Sidebar chat start -->
      ...
      <div class="content-wrapper pt-5 pb-5">
         ...
         <h4 class="ml-3">Create a new Coupons</h4><br>
         <div class="row pl-3 pr-3">
           <div class="col-md-5">
             <form class="form" id="form" method="post" action="createCoupon.php">
                 <label> Coupon Title</label>
                 <input class="form-control mb-3" type="text" name="title" placeholder="Enter Coupon Title " id="title" required="">
                 <label> Coupon Code</label>
                 <input class="form-control mb-3" type="text" name="code" placeholder="Enter Coupon Code " id="code" required="">
                 <label>Start Date</label>
                 <input class="form-control mb-3" type="date" name="start" placeholder="Enter Start Date " id="start" required="">
                 <label> End Date</label>
                 <input class="form-control mb-3" type="date" name="end" placeholder="Enter Enda Date " id="end" required="">
                 <label> Coupon Discount</label>
                 <input class="form-control mb-3" type="text" name="discount" placeholder="Enter Coupon Discount " id="discount" required="">
                 <input type="submit" name="submit" class="btn btn-primary" value="Upload" id="upload"><br><br><br><br><br><br>
               </form>
           </div><br>
         </div>
