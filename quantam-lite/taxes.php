...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/aroma/style.css">
   <!-- Responsive.css-->
...
<body class="sidebar-mini fixed" style="background-color:#ebeff2;">
   <div class="wrapper">
      ...
      <div class="content-wrapper pt-5" style="background-color:white;">
         ...
         <h4 class="ml-2">Taxes</h4>
         <div class="row p-1 mt-3">
           <div class="col-md-10">
             <!--Coupon list displaying in table -->
                <table class="table bg-white" style="margin-bottom: 600px;">
                  <!-- table heading -->
                  <thead>
                    <tr>
                      <th scope="col">Tax Details</th>
                      <th scope="col">Tax Schedule</th>
                  ...
                  ?>
                    <tr class="col bg-danger">
                      ...
                      <td>$USD <?php echo $row["rate"]; ?></td>
                      <td>$USD <?php echo $row["amount"]; ?></td>
                      <form method="post" action="listCoupon.php">
                        <input type="hidden" name="id" value="" id="cid">
                        <input class="invisible" type="submit" name="submit" id="btn">
                      </form>
                      <td><i class="icon-bubbles" onclick="update(<?php echo $row["id"]; ?>)"></i><i class="icon-bubbles" onclick="delete_coupon(<?php echo $row["id"]; ?>)"></i></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
