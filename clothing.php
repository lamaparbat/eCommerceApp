      ...
      <div class="row">
        <div class="col-md-10 mx-auto">
          <div class="card-columns">
            <?php
            $select = "SELECT * FROM store WHERE collectiontype !=  'Accessories' AND collectiontype !=  'Shoes' ";
              ...
              <div class="card card1">
                ...
                <div class="card-body pt-2 pb-3">
                  ...
                  <form method="post">
                    ...
                    <?php } ?><br>
                    <input type="submit" class="btn mt-1 btn-info mt-1 rounded-0 pr-2 pl-2 pt-0 pb-0" id="product_id" name="product_id" value="Buy Now">
                  </form>
                </div>
              </div>
              <!-- /end of cards -->
