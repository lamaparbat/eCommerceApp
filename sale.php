            ...
            ?>
                ...
                <div class="card card1">
                  ...
                  <div class="card-body pt-2 pb-3">
                    <p class="card-text mb-3" style="letter-spacing: 1px; line-height: 1.1;"><?php echo $row["pname"]; ?></p>
                    <p class="card-title mb-2" style="margin-top: -10px; letter-spacing: 1px;"><label class="text-danger"><del>$USD<?php echo $row['pprice']; ?></del></label> &nbsp <?php echo $row['discount']; ?>% OFF</p>
                    <form method="post">
                      ...
                      <?php } ?><br>
                      <input type="submit" class="btn btn-info mt-1 rounded-0 pr-2 pl-2 pt-0 pb-0" name="product_id" value="Buy Now">
                    </form>
                  </div>
                </div>
                <!-- /end of cards -->
